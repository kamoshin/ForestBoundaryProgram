...
def layer3_cnn(input_shape, num_classes):
        ...
        self._target.fit(
            ...
            callbacks=[
                ...
                ModelCheckpoint(os.path.join(self.log_dir,'model_{epoch:02d}_{val_accuracy:.2f}.h5'), \
                    monitor='val_accuracy', period=50),
                #self.lr
            ],
...
train_dir = './../../../Data/trimed_img/unresize_randomsampling_reduce_class_train/'
vali_dir = './../../../Data/trimed_img/unresize_randomsampling_reduce_class_test/'
