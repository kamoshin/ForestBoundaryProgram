...
# save_dir = './../Experiments/'+aug+'/'
# if os.path.exists(save_dir):
#     print('save_dir is exists')
# else:
#     os.mkdir(save_dir)

# model_path = './../Materials/Models/model'+aug+'.h5'
# test_dir = './../Materials/Dataset/test/'

save_dir = './../../Data/Models/DenseNet32/'
if os.path.exists(save_dir):
    print('save_dir is exists')
else:
    os.mkdir(save_dir)

model_path = save_dir+'model_best.h5'
# model_path = './../../Data/three_pronged/ensemble/Models/model1/model_2000_0.74.h5'
test_dir = './../../Data/trimed_img/fewdata_dataaugumentation/test/'
...
with open(save_dir+'wrong_img.csv','w', newline="") as f:
    ...
    for path, true, pred in zip(image_path_list, true_classes, predicted):
