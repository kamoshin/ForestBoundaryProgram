...
japanese_cedar_model_path = ''
japanese_cypress_model_path = ''
other_tree_model_path = ''
not_tree_model_path = ''
...
japanese_cedar_model = load_model(japanese_cedar_model_path)
japanese_cypress_model = load_model(japanese_cypress_model_path)
other_tree_model = load_model(other_tree_model_path)
not_tree_model = load_model(not_tree_model_path)
...
for image_n in image_list:
    ...
    for y in range(0, height):
        for x in range(0, width):
            japanese_cedar_value = []
            japanese_cypress_value = []
            other_tree_value = []
            not_tree_value = []
            # 256 pred value
            japanese_cedar_value.append(pred_keeper256[y][x][0])
            japanese_cypress_value.append(pred_keeper256[y][x][1])
            other_tree_value.append(pred_keeper256[y][x][2])
            not_tree_value.append(pred_keeper256[y][x][3])
            # 128 pred value
            japanese_cedar_value.append(pred_keeper128[y][x][0])
            japanese_cypress_value.append(pred_keeper128[y][x][1])
            other_tree_value.append(pred_keeper128[y][x][2])
            not_tree_value.append(pred_keeper128[y][x][3])
            # 64 pred value
            japanese_cedar_value.append(pred_keeper64[y][x][0])
            japanese_cypress_value.append(pred_keeper64[y][x][1])
            other_tree_value.append(pred_keeper64[y][x][2])
            not_tree_value.append(pred_keeper64[y][x][3])
            # 32 pred value
            japanese_cedar_value.append(pred_keeper32[y][x][0])
            japanese_cypress_value.append(pred_keeper32[y][x][1])
            other_tree_value.append(pred_keeper32[y][x][2])
            not_tree_value.append(pred_keeper32[y][x][3])
            #predict
            japanese_cedar_model.predict(japanese)
