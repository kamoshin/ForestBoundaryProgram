...
#orig_dir = './../../../Original_Dataset/test/'

save_dir = "./../../Data/trimed_img/test_128/"
...
def main():
    #photo_name_list = ['shijukuin','myodan','bodai','kurikara','nashitani','rokuro','togi','yoshikuraB']
    photo_name_list = ['ushitsu', 'yuusenji']
    # 512*512,train
    #photo_name_list = ['bamba','bodai','kurikara','matii','nashitani','oritani','rokuro','takemata','togi','urii','yoshikuraB']
            ...
            for x in range(0,width,slide):
                for y in range(0,height,slide):
                    ...
                    if np.sum(bin_image == 255) == w*h and np.sum(black_in_image == 255) == 0:
                        ...
                        save_name = save_dir+target_name+"/"+photo_name+"_"+str(save_image_num)+point+".jpg"
